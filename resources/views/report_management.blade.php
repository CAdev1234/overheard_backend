...
@section('content body')
	<section role="main" class="content-body">
		...
		<section class="card">
			...
			<div class="card-body">
				<table class="table table-bordered table-striped" id="datatable-reportlist" data-url="ajax/ajax-datatables-sample.json">
					<thead>
					<tr>
						<th width="10%">REPORT</th>
						<th width="25%">REPORTER</th>
						<th width="25%">REPORTED</th>
						<th width="20%">DATE OF REPORT</th>
...
@section('page js')
	<script src="{{asset('assets/js/reports.tables.editable.js')}}"></script>
